...
export const sendVitalSigns = async () => {
    ...
    const VitalSigns = {
        heartRate: Math.round(randomInRange(60, 100)),                                                  // 隨機心率範圍 60 到 100
        bloodPressure: `${Math.round(randomInRange(90, 120))}/${Math.round(randomInRange(60, 80))}`,    // 隨機血壓範圍 90/60 到 120/80
        bodyTemperature: parseFloat(randomInRange(36.5, 37.3).toFixed(1))                               // 隨機體溫範圍 36.5°C 到 37.3°C，精確到小數點後一位
    };
